...
/**
 * Calculate the length of the fortune cookie.
 *
 * We expect this to be one less than the byte length of the cookie, since that
 * has a trailing newline.
 *
 * @return {number}
 */
Cookie.prototype.length = function() {
  return this.cookie.length - 1;
};
